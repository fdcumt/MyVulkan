...
struct QueueFamilyIndices {
    ...
    QueueFamilyIndices(const QueueFamilyIndices& InValue)
    {
        graphicsFamily = InValue.graphicsFamily;
        presentFamily = InValue.presentFamily;
    }
    TOptional<uint32_t> graphicsFamily;
    TOptional<uint32_t> presentFamily;
...
private:
    ...
    void createLogicalDevice() {
        ...
        std::set<uint32_t> uniqueQueueFamilies = {
            indices.graphicsFamily.GetValue(),
            indices.presentFamily.GetValue()};
        ...
        vkGetDeviceQueue(device,
            indices.graphicsFamily.GetValue(), 0, &graphicsQueue);
        vkGetDeviceQueue(device,
            indices.presentFamily.GetValue(), 0, &presentQueue);
    }
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = FFileHelper::ReadFile(FPath::GetShaderSpvDir()+"VertexShader.spv");
        auto fragShaderCode = FFileHelper::ReadFile(FPath::GetShaderSpvDir()+"FragmentShader.spv");
